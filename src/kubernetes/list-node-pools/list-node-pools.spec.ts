...
import { createContext } from '../../commom';
import {listNodePools} from './list-node-pools';
import * as MOCK from './list-node-pools.mock';
...
describe('kubernetes', () => {
  ...
  describe('list-node-pools', () => {
    ...
    it('should return a valid response', async () => {
      ...
      const response = await _listNodePools({
      ...
      expect(response.data.node_pools).toBeDefined();
      const {node_pools} = response.data;
      const [node_pool] = node_pools;

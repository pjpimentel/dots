 ...
 */
var CertificateEndpoint = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new certificate_1.default(this, cert)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.prefix;
                        return [4 /*yield*/, this.getCollection(page, perPage, url, 'Certificates')];
                    case 1:
                        collection = _a.sent();
                        collection = this.upcastCollection(collection, certificate_1.default);

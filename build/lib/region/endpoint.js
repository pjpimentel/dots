 ...
 */
var RegionEndpoint = (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = this.prefix;
                        return [4 /*yield*/, this.getCollection(page, perPage, url, 'regions')];
                    case 1:
                        collection = _a.sent();
                        collection = this.upcastCollection(collection, region_1.default);
